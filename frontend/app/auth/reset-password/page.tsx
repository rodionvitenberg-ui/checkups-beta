...
function ResetPasswordContent() {
    ...
    if (mode === 'request' && isSuccess) {
        return (
            ...
            <div className="relative z-10 bg-white/90 backdrop-blur-md w-full max-w-md rounded-2xl shadow-xl p-8 text-center border border-white/40">
...
export default function ResetPasswordPage() {
    return (
        // ПРАВИЛО 1: Убрали bg-slate-50, поменяли div на main className="relative..."
        <main className="relative min-h-[calc(100vh-64px)] flex items-center justify-center p-4">
            ...
            {/* ПРАВИЛО 3: Оборачиваем контент (Suspense) в relative z-10 */}
